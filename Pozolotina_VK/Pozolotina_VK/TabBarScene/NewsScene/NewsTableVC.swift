...
var newsCell = [
    ...
    News(ava: UIImage(named: "cat")!, name: "Екатерина Кошкина", time: "15 апреля в 18:45", text: "Некоторые кошки издают звук, подобный бормотанию или щебетанию. Производится он слегка открытой пастью и обозначает приветствие или привлечение внимания.", picture: nil, touches: 76, watches: 546),
    News(ava: UIImage(named: "cat")!, name: "Екатерина Кошкина", time: "15 апреля в 18:45", text: nil, picture: UIImage(named: "cat")!, touches: 76, watches: 546)]
